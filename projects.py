...
with st.container(border=False):
    ...
    with row1_col1:
        ...
        st.image("menu_eng.jpg", use_container_width=True)
    ...
    with row1_col2:
        ...
        st.image("docker.jpg", use_container_width=True)
    ...
    with row1_col3:
        ...
        st.image("reports.jpg", use_container_width=True)
...
with st.container(border=False):
    ...
    with row1_col1:
        ...
        st.image("market_basket.jpg", use_container_width=True)
    ...
    with row1_col2:
        ...
        st.image("dashboard.jpg", use_container_width=True)
    ...
    with row1_col3:
        ...
        st.image("inventory.jpg", use_container_width=True)
