...
with a strong track record in the <strong>hospitality and restaurant industry</strong>. Whether it's uncovering trends,
building dashboards, or improving operations, I love using data to solve real-world problems.
<br><br>
